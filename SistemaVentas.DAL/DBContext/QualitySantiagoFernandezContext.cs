...
public partial class QualitySantiagoFernandezContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C9852FA64");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FC30DB676");

            entity.Property(e => e.IdDetalleVenta).HasColumnName("idDetalleVenta");
            entity.Property(e => e.Catnidad).HasColumnName("catnidad");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483D0E52192");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A47F0D0E2B");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421AAEF16188");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13266F44A2B");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F762D208FC5");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A645FE90F4");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56147131B7E0");
